...
if (code.includes(target2)) {
    ...
    console.log('patched global member info');
} else {
    console.log('target2 not found');
}

const target3 = `                {customerDisplayData.memberInfo && (
...
if (code.includes(target3)) {
    ...
    console.log('removed right-column member info');
} else {
